...
package gradle.kotlin.dsl.plugins._6da0b9cd9aaff10ae66bb45e5e997956
...
/**
 * The `fabric-loom` plugin implemented by [net.fabricmc.loom.LoomGradlePlugin].
 */
internal
val `PluginDependenciesSpec`.`fabric-loom`: PluginDependencySpec
    get() = this.id("fabric-loom")
...
/**
 * The `net.fabricmc` plugin group.
 */
@org.gradle.api.Generated
internal
class `NetFabricmcPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `net.fabricmc`.
 */
internal
val `NetPluginGroup`.`fabricmc`: `NetFabricmcPluginGroup`
    get() = `NetFabricmcPluginGroup`(plugins)


/**
 * The `net.fabricmc.fabric-loom` plugin implemented by [net.fabricmc.loom.LoomNoRemapGradlePlugin].
 */
internal
val `NetFabricmcPluginGroup`.`fabric-loom`: PluginDependencySpec
    get() = plugins.id("net.fabricmc.fabric-loom")


/**
 * The `net.fabricmc.fabric-loom-companion` plugin implemented by [net.fabricmc.loom.LoomCompanionGradlePlugin].
 */
internal
val `NetFabricmcPluginGroup`.`fabric-loom-companion`: PluginDependencySpec
    get() = plugins.id("net.fabricmc.fabric-loom-companion")


/**
 * The `net.fabricmc.fabric-loom-remap` plugin implemented by [net.fabricmc.loom.LoomRemapGradlePlugin].
 */
internal
val `NetFabricmcPluginGroup`.`fabric-loom-remap`: PluginDependencySpec
    get() = plugins.id("net.fabricmc.fabric-loom-remap")


/**
 * The `net.fabricmc.fabric-loom-repositories` plugin implemented by [net.fabricmc.loom.LoomRepositoryPlugin].
 */
internal
val `NetFabricmcPluginGroup`.`fabric-loom-repositories`: PluginDependencySpec
    get() = plugins.id("net.fabricmc.fabric-loom-repositories")
