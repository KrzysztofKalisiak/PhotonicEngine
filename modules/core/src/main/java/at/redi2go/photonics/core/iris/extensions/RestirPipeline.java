...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info("Photonics feature set: direct-light-v25 canonical ReSTIR proposal weighting with one expected moving-light candidate per pixel, stable frame-aligned Sable light history, coarse same-sublevel visibility, Sable receiver motion reprojection, SVGF quality floor, moving-light and Iris material bridges; finite-segment OOB visibility and tree-origin tracing, masked passes, texture barriers, temporal reuse, accumulation, denoising, handheld; spatial and combined GI compatibility gates active");
