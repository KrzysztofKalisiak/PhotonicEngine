...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info(
                "Photonics ReSTIR configuration v46: directCandidatesPerPixel={}, directTemporalSampleCap={}, spatialCandidates={}, spatialRadiusPixels={}, spatialPolicy=ordinary-world-all-lights+explicit-token-stationary-same-sublevel/current-visibility/immutable-input/initial-batch-cap+rejected-fallback-cap+background-finalization, historyPolicy=receiver-relative-split-stable-external/representative-scoped-reactivity/explicit-emitter-domain/0.15-block-trail/2-frame-floor+same-sublevel-domain-hysteresis, requestedDenoiserPasses={}, effectiveDenoiserPasses={}, softShadows={}, combinedGi={}",
