...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info(
                "Photonics ReSTIR GI v78: combinedGi={}, initialGi=full-rate/v75-v76-interleave-removed, renderScale=independent-native-gbuffer-coordinate-remap+scale-aware-depth-denoising, temporalReservoirReuse=ordinary-world-only, indirectSpatialReuse=world-only-immutable-geometry-guided/8-attempt-independent-stream, handSableReservoirHistory=false, indirectStorage=rgba32f+rgb32ui, passFusion=initial-direct-visibility+final-indirect-visibility, timing=per-stage+frame-throughput",
