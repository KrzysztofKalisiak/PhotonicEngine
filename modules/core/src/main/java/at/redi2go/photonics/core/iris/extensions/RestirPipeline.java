...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info(
                "Photonics ReSTIR GI validation v87: compact first-segment surface signatures, pre-merge current-receiver validation, invalid-history exclusion, maxTemporalCandidates=1, maxSpatialCandidates=1, maxTraversalSteps=128"
        );
    ...
    private void buildCombinedPipeline(IrisFactory irisFactory) {
        ...
        irisFactory.newPipeline()
                ...
                .deferredPass("temporal reuse + candidate GI prevalidation", "/photonics/rendering/restir/passes/r4_temporal_reuse.fsh", null, this::isRestirEnabled)
                ...
                .deferredPass("spatial reuse/clamp + candidate GI prevalidation", "/photonics/rendering/restir/passes/r5_spatial_reuse.fsh", null, this::isRestirEnabled)
    ...
    private void buildSplitGiPipeline(IrisFactory irisFactory) {
        ...
        irisFactory.newPipeline()
                ...
                .withFramebuffer(giReservoirFramebuffer)
                .deferredPass(
                        "temporal reuse + candidate prevalidation",
                ...
                .withFramebuffer(giReservoirFramebuffer)
                .deferredPass(
                        "spatial reuse/clamp + candidate prevalidation",
