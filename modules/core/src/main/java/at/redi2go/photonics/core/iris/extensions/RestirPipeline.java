...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info("Photonics feature set: direct-light-v20 Sable moving-light and Iris material bridges; finite-segment OOB visibility and tree-origin tracing, masked passes, texture barriers, temporal reuse, accumulation, denoising, handheld; spatial and combined GI compatibility gates active");
        ...
        Photonics.LOGGER.info(
                "Photonics ReSTIR configuration v20: directCandidatesPerPixel={}, directTemporalSampleCap={}, spatialCandidates={}, requestedDenoiserPasses={}, effectiveDenoiserPasses={}, softShadows={}, combinedGi={}",
