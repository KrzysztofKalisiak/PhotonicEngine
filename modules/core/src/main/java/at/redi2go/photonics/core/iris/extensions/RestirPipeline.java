...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info(
                "Photonics ReSTIR configuration v44: directCandidatesPerPixel={}, directTemporalSampleCap={}, spatialCandidates={}, spatialRadiusPixels={}, spatialPolicy=ordinary-world-all-lights+explicit-token-rigid-same-sublevel/current-visibility/immutable-input/initial-batch-cap+rejected-fallback-cap, historyPolicy=split-stable-external/representative-scoped-reactivity/receiver-relative/explicit-emitter-domain/0.15-block-trail/2-frame-floor+same-sublevel-domain-hysteresis, requestedDenoiserPasses={}, effectiveDenoiserPasses={}, softShadows={}, combinedGi={}",
