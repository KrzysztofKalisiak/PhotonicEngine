...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info(
                "Photonics ReSTIR GI v75: combinedGi={}, initialGi=history-aware-checkerboard/stable-world-only/full-rate-disocclusion-hand-sable, temporalReservoirReuse=ordinary-world-only, indirectSpatialReuse=world-only-immutable-geometry-guided/8-attempt-independent-stream, handSableReservoirHistory=false, indirectStorage=rgba32f+rgb32ui, passFusion=initial-direct-visibility+final-indirect-visibility, timing=per-stage",
