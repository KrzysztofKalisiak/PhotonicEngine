...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info(
                "Photonics ReSTIR GI completion: compact finite-path surface signatures, winner-only temporal/spatial validation, and current-receiver fallback on stale reused paths"
        );
    ...
    private void buildCombinedPipeline(IrisFactory irisFactory) {
        ...
        irisFactory.newPipeline()
                ...
                .deferredPass("temporal reuse + selected-history GI validation", "/photonics/rendering/restir/passes/r4_temporal_reuse.fsh", null, this::isRestirEnabled)
                ...
                .deferredPass("spatial reuse/clamp + selected-neighbor GI validation", "/photonics/rendering/restir/passes/r5_spatial_reuse.fsh", null, this::isRestirEnabled)
    ...
    private void buildSplitGiPipeline(IrisFactory irisFactory) {
        ...
        irisFactory.newPipeline()
                ...
                .withFramebuffer(giReservoirFramebuffer)
                .deferredPass(
                        "temporal reuse + selected-history validation",
                ...
                .withFramebuffer(giReservoirFramebuffer)
                .deferredPass(
                        "spatial reuse/clamp + selected-neighbor validation",
