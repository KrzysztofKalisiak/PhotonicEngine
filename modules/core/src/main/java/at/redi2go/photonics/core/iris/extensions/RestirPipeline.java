...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info(
                "Photonics ReSTIR configuration v39: directCandidatesPerPixel={}, directTemporalSampleCap={}, spatialCandidates={}, spatialRadiusPixels={}, spatialPolicy=ordinary-world-all-lights+rigid-same-sublevel/current-visibility/immutable-input/initial-batch-cap, requestedDenoiserPasses={}, effectiveDenoiserPasses={}, softShadows={}, combinedGi={}",
