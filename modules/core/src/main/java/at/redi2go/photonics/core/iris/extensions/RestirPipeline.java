...
public class RestirPipeline extends AbstractPhotonicsExtension {
    ...
    public RestirPipeline(
        ...
        Photonics.LOGGER.info(
                "Photonics ReSTIR GI v69: combinedGi={}, temporalReservoirReuse=ordinary-world-only, indirectSpatialReuse=world-only-immutable-single-neighbor, handSableReservoirHistory=false, indirectStorage=rgba32f+rgb32ui",
