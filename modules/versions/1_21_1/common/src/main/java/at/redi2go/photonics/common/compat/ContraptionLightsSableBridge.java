...
public final class ContraptionLightsSableBridge {
    ...
    private static void logSkyLightScale(
        ...
        if (!skyLightDiagnosticsLogged) {
            ...
            Photonics.LOGGER.info(
                    "Photonics v54 Sable skylight diagnostics active: source=ClientSubLevel.latestSkyLightScale, freezeGetter={}",
        ...
        Photonics.LOGGER.info(
                "Photonics v54 Sable skylight transition: subLevel={}, scale={} -> {}, logicalY={} (cell {}), renderY={} (cell {}), cameraY={} (cell {})",
                uniqueId,
